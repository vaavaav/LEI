...
void prepareCilinder(float height, float radius, int sides) {
	...
	float *v = new float[4 * 3 * 3 * sides];
	float *n = new float[4 * 3 * 3 * sides];
...
void renderScene(void) {
	...
	float pos_light[4]={1.0,1.0,1.0,0.0};
...
// init GLEW
	...
	GLfloat dark[4]={0.2,0.2,0.2,1.0}; GLfloat white[4]={1.0,1.0,1.0,1.0};
	//lightcolors
